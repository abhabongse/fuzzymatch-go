...
/*
DefaultExtractBareNames is a preset function which generates a sequence of all possible
...
*/
var DefaultExtractBareNames = MakeBareNamesExtractor(DefaultTitledNamePatterns)
